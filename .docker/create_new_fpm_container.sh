...
do 
 ...
 # change Dockerfile
 sed -Ei "s?__DOCUMENT_ROOT__?${DOCUMENT_ROOT}?g" php7-fpm-template/Dockerfile
 sed -Ei "s?__PRESTASHOP_RELEASE__?${PRESTASHOP_RELEASE}?g" php7-fpm-template/Dockerfile
 sed -Ei "s?__FPM_POOL_PORT__?${FPM_POOL_PORT}?g" php7-fpm-template/Dockerfile
